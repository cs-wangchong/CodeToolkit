...
package srctoolkit.janalysis.common.collections;


import srctoolkit.janalysis.common.graph.DefaultMatcher;
import srctoolkit.janalysis.common.graph.Holder;
import srctoolkit.janalysis.common.graph.Matcher;
...
public class MatcherLinkedHashMap<K, V> implements Map<K, V> {
    ...
    public Set<Entry<K, V>> entrySet() {
        Set<Entry<K, V>> entries = new LinkedHashSet<>(map.size());
        for (Holder<K> k: map.keySet())
