...
import srctoolkit.janalysis.common.collections.IdentityLinkedHashSet;
...
public class IdentityDigraph<V,E> extends Digraph<V,E> {
    ...
    public Set<Edge<V,E>> copyEdgeSet() {
        return new IdentityLinkedHashSet<>(allEdges);
    }
    
    @Override
    public Set<V> copyVertexSet() {
        return new IdentityLinkedHashSet<>(allVertices);
    }
     ...
     * 
     * If identity checking is desired, use {@link #hasVertex(Object) {@code hasVertex(v)}}.
     *
     ...
     *
     * If equality checking is desired, use {@link #containsVertex(Object) {@code containsVertex(v)}}.
     *
     ...
     * the given object isn't necessarily included in this {@code IdentityGraph}.
     *
     * If identity checking is desired, use {@link #hasEdge(Edge) {@code hasEdge(e)}}.
     *
     ...
     * Note that this method uses identity checking, and not equality.
     *
     * If equality checking is desired, use {@link #containsEdge(Edge) {@code containsEdge(e)}}.
     *
     ...
     *
     * If identity checking is desired, use {@link #hasEdge(Edge) {@code hasEdge(src, trg)}}.
     *
     ...
     * use {@link #containsEdge(Object, Object) {@code containsEdge(src, trg)}}.
     * 
